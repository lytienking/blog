                                ...
                                <ul className="dropdown-menu megamenu" aria-labelledby="dropdown01">
                                    <li>
                                        <div className="mega-menu-content clearfix">
                                            <div className="tab">
                                                <button className="tablinks active" >Beauty</button>
                                                <button className="tablinks" >Fashion</button>
                                                <button className="tablinks" >Travel</button>
                                                <button className="tablinks" >Architecture</button>
                                                <button className="tablinks" >Recipes</button>
                                            </div>
